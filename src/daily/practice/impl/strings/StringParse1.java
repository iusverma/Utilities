...
public class StringParse1 {
    ...
    public int solution(String S) {
        ...
        // Step 2: eliminate string which are not eligible or doesn't have an upper case character
        ...
        System.out.println("Number of possible passwords in string: " + S + " is: " + listOfPasswords.size());
    ...
    /**
     * This function breaks original string into list of string,
     * Each substring is extracted from between two digits.
     */
    private void parseSubstrings(String S){
    ...
    /**
     * This function eliminates all substrings from a list, 
     * which doesn't have a upper case character in it.   
     */
